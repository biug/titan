...
public:
	...
	virtual const GuardLoc *		IsGuardLoc() const				{ return nullptr; }
	virtual GuardLoc *				IsGuardLoc()					{ return nullptr; }
	...
	virtual const HangingBase *		IsHangingBase() const			{ return nullptr; }
	virtual HangingBase *			IsHangingBase()					{ return nullptr; }

	virtual const SKTAttack *		IsSKTAttack() const				{ return nullptr; }
	virtual SKTAttack *				IsSKTAttack()					{ return nullptr; }
