...
public:
	...
	bool							GuardInNatural() const				{ CI(this); return m_guardInNatural; }
	void							SetGuardInNatural()					{ CI(this); m_guardInNatural = true; }

	bool							GuardInLoc() const					{ CI(this); return m_guardInLoc; }
	void							SetGuardInLoc()						{ CI(this); m_guardInLoc = true; }

	bool							SKTRush() const						{ CI(this); return m_sktRush; }
	void							SetSKTRush()						{ CI(this); m_sktRush = true; }
	void							UnsetSKTRush()						{ CI(this); m_sktRush = false; }

	bool							LastOrder() const					{ CI(this); return m_lastOrder; }
	void							SetLastOrder()						{ CI(this); m_lastOrder = true; }
	void							UnsetLastOrder()					{ CI(this); m_lastOrder = false; }
...
private:
	...
	bool							m_guardInNatural = false;	//  ÿŒ¿∑÷øÛ
	bool							m_guardInLoc = false;		//  ÿŒ¿Œª÷√
	bool							m_sktRush = false;
	bool							m_lastOrder = false;		// ◊Ó÷’√¸¡Ó
};
...
public:
	...
	void								UnWall()						{CI(this); assert_throw(m_pWall); m_pWall = nullptr; }
