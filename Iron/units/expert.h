...
public:
	...
	TilePosition				GetSpecLocation() const				{ return m_specLocation; }
	void						SetSpecLocation(TilePosition loc)	{ m_specLocation = loc; }
...
private:
	...
	TilePosition				m_specLocation = TilePositions::None;
};
...
public:
	...
	int							GetID() const override { return (int)m_tid; }
	int							GetType() const override { return (int)MacroItems::Unit; }
...
public:
	...
	int							GetID() const override { return m_type == tech ? (int)m_techType : (int)m_upgradeType; }
	int							GetType() const override { return (int)(m_type == tech ? MacroItems::Tech : MacroItems::Upgrade); }
...
protected:
	...
	MyBuilding *				Where() const	{ return m_pWhere; }
	TechType					GetTechType() const	{ assert_throw(m_type == tech); return m_techType; }
	UpgradeType					GetUpgradeType() const	{ assert_throw(m_type == upgrade); return m_upgradeType; }
